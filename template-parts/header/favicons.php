...
<link rel="manifest" href="<?php echo esc_url( DIS_THEME_URL . '/assets/favicons/manifest.webmanifest' ); ?>">
<link rel="icon" href="<?php echo esc_url( DIS_THEME_URL . '/assets/favicons/favicon-16x16.png' ); ?>">
<link rel="mask-icon" href="<?php echo esc_url( DIS_THEME_URL . '/assets/favicons/safari-pinned-tab.svg' ); ?>" color="#0066CC">
<meta name="msapplication-config" content="<?php echo esc_url( DIS_THEME_URL . '/assets/favicons/browserconfig.xml' ); ?>">
