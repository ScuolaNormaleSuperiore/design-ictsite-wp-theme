...
/**
 * Manager for the FAQ custom post type.
 */
class DIS_FaqManager {
	/**
	...
	public function add_taxonomies() {
		$taxonomy_labels = array(
			'name'          => _x( 'Topics', 'DIS_TaxonomyGeneralName', 'design_ict_site' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			'singular_name' => _x( 'Topic', 'DIS_TaxonomySingularName', 'design_ict_site' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			'add_new_item'  => __( 'Add a topic', 'design_ict_site' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			'menu_name'     => __( 'Topics', 'design_ict_site' ), // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		);
		$taxonomy_args   = array(
			'hierarchical'      => true,
