...
class DIS_OptionsManager {
	...
	public function add_opt_advanced_settings( $option_key, $tab_group, $capability ) {
		...
		$advanced_options->add_field(
			array(
				'id'      => 'wp_sitemap_enabled',
				'name'    => __( 'Enable the default WP sitemap', 'design_ict_site' ),
				'desc'    => __( 'Publish the sitemap generated by WordPress at /wp-sitemap.xml. The theme sitemap at /sitemap-index.xml, which is language aware, stays available in either case.', 'design_ict_site' ),
				'type'    => 'radio_inline',
				'default' => 'true',
				'options' => array(
					'true'  => __( 'Yes', 'design_ict_site' ),
