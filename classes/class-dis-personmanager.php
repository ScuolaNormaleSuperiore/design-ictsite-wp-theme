...
/**
 * Manager for the person custom post type.
 */
class DIS_PersonManager {
	/**
	...
	public function attach_taxonomies() {
		register_taxonomy_for_object_type( DIS_DEFAULT_CATEGORY, DIS_PERSON_POST_TYPE );
		register_taxonomy_for_object_type( DIS_DEFAULT_TAGS, DIS_PERSON_POST_TYPE );
	}
