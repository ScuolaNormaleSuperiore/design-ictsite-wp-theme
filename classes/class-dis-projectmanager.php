...
/**
 * Manager for the project custom post type.
 */
class DIS_ProjectManager {
	/**
	...
	public function add_post_type() {
		...
		$args = array(
			...
			'show_in_rest'  => true,
			'rewrite'       => array(
				'slug'       => dis_ct_data()[ DIS_PROJECT_POST_TYPE ]['slug'],
				'with_front' => true,
			),
	...
	public function attach_taxonomies() {
		register_taxonomy_for_object_type( DIS_DEFAULT_CATEGORY, DIS_PROJECT_POST_TYPE );
		register_taxonomy_for_object_type( DIS_DEFAULT_TAGS, DIS_PROJECT_POST_TYPE );
	}
