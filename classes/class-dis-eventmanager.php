...
/**
 * Manager for the event custom post type.
 */
class DIS_EventManager {
	/**
	...
	public function attach_taxonomies() {
		register_taxonomy_for_object_type( DIS_DEFAULT_CATEGORY, DIS_EVENT_POST_TYPE );
		register_taxonomy_for_object_type( DIS_DEFAULT_TAGS, DIS_EVENT_POST_TYPE );
	}
